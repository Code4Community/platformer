...
export default class TutorialECSScene extends ECSScene
{
	...
	this.physics.add.overlap(this.playerObject, this.stars, this.collectStar, null, this);
	...
	this.physics.add.collider(this.playerObject, this.bombs, this.hitBomb, null, this);
    }
	...
	if (this.stars.countActive(true) === 0) {
	    ...
	    var x = (this.playerObject.x < 400) ? Phaser.Math.Between(400, 800) : Phaser.Math.Between(0, 400);
